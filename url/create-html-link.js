...
var get_hostname_1 = require("../string/get-hostname");
var createHtmlLink = function (_a) {
    ...
    return "<a " + (noopener ? 'rel="noopener"' : "") + " target=\"" + (blank ? "_blank" : "_self") + "\" href=\"" + prefix + url + "\">" + (domain ? get_hostname_1.getHostname(url) : inner || url) + "</a>";
};
